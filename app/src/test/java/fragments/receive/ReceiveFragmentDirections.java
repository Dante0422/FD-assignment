...
public class ReceiveFragmentDirections {
  ...
  @NonNull
  public static ActionReceiveFragmentToDonorLocationFragment actionReceiveFragmentToDonorLocationFragment(
      @NonNull Donation donation) {
    return new ActionReceiveFragmentToDonorLocationFragment(donation);
  }

  public static class ActionReceiveFragmentToDonorLocationFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionReceiveFragmentToDonorLocationFragment(@NonNull Donation donation) {
      if (donation == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionReceiveFragmentToDonorLocationFragment setDonation(@NonNull Donation donation) {
      if (donation == null) {
        throw new IllegalArgumentException("Argument \"donation\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("donation", donation);
    ...
    public int getActionId() {
      return R.id.action_receiveFragment_to_donorLocationFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionReceiveFragmentToDonorLocationFragment that = (ActionReceiveFragmentToDonorLocationFragment) object;
    ...
    public String toString() {
      return "ActionReceiveFragmentToDonorLocationFragment(actionId=" + getActionId() + "){"
